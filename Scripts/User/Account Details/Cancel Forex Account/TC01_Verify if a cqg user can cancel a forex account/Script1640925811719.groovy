...
WebUI.click(findTestObject('User/Account Details/Forex Account Details/Forex_cancel_button'))

WebUI.click(findTestObject('User/Account Details/Forex Account Details/Confirmation_popup_yes_button'))

WebUI.verifyElementPresent(findTestObject('User/Account Details/Forex Account Details/Cancel_forex_account_success_message'), 
    0)
