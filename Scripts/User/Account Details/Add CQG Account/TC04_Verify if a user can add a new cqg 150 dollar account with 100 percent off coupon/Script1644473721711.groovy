...
WebUI.click(findTestObject('User/Account Details/Add_Futures_Account_button'))

WebUI.click(findTestObject('User/Account Details/Add Futures Account/150plan_select_button'))

WebUI.setText(findTestObject('User/Account Details/Add Futures Account/Couponcode_textbox'), GlobalVariable.Coupon100)

WebUI.click(findTestObject('User/Account Details/Add Futures Account/Coupon_apply_button'))

WebUI.check(findTestObject('User/Account Details/Add Futures Account/I_agree_checkbox'))

WebUI.click(findTestObject('User/Account Details/Add Futures Account/Credit_card_button'))
...
WebUI.verifyElementPresent(findTestObject('User/Account Details/Add Futures Account/add_cqg_account_success_message'), 0)
