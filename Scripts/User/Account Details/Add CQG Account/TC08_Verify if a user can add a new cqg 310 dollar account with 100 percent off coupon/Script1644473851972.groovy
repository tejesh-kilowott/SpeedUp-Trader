...
WebUI.click(findTestObject('Trade Page/310plan_select_button'))

WebUI.setText(findTestObject('Payment-AddAccount Page/Couponcode_textbox'), GlobalVariable.Coupon100)

WebUI.click(findTestObject('Payment-AddAccount Page/Coupon_apply_button'))
