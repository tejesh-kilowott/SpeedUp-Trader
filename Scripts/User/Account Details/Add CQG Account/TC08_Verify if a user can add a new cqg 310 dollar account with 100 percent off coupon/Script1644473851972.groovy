...
WebUI.click(findTestObject('User/Account Details Page/Add Futures Account/310plan_select_button'))

WebUI.setText(findTestObject('User/Account Details Page/Add Futures Account/Couponcode_textbox'), GlobalVariable.Coupon100)

WebUI.click(findTestObject('User/Account Details Page/Add Futures Account/Coupon_apply_button'))
