...
WebUI.click(findTestObject('Account Details Page/CQG Account Details/Cqg_accordian_button'))

WebUI.click(findTestObject('Account Details Page/CQG Account Details/Cqg_accrodian_drop_details_arrow'))
...
WebUI.verifyElementPresent(findTestObject('Account Details Page/CQG Account Details/Reset_cqg_account_success_message'), 
    0)
