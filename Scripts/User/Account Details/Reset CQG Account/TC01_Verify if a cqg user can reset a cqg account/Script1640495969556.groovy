...
WebUI.click(findTestObject('User/Account Details Page/Cqg_accordian_button'))

WebUI.click(findTestObject('User/Account Details Page/CQG Account Details/Cqg_accrodian_drop_details_arrow'))

WebUI.click(findTestObject('User/Account Details Page/CQG Account Details/Cqg_Reset_button'))
...
WebUI.verifyElementPresent(findTestObject('User/Account Details Page/CQG Account Details/Reset_cqg_account_success_message'), 
    0)
