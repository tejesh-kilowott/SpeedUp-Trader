...
WebUI.click(findTestObject('Account Details Page/Rhithmic_accordian_button'))

WebUI.click(findTestObject('Account Details Page/Rhithmic Account Details/Rhithmic_accordian_drop_details_arrow'))

WebUI.click(findTestObject('Account Details Page/Rhithmic Account Details/Rhithmic_reset_button'))

WebUI.click(findTestObject('Account Details Page/CQG Account Details/Credit_card_button'))
...
WebUI.verifyElementPresent(findTestObject('Account Details Page/Rhithmic Account Details/Reset_rhithmic_success_message'), 
    0)
