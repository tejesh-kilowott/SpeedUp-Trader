...
WebUI.click(findTestObject('Index Page/310_plan_select_button'))
...
WebUI.click(findTestObject('User Register Page/Rhithmic_platform_radiobutton'))

WebUI.click(findTestObject('User Register Page/Rhithmic_professional_trader_radiobutton'))
