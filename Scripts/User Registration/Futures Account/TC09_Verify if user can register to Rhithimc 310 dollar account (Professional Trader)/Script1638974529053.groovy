...
WebUI.click(findTestObject('Register Page/Rhithmic_platform_radiobutton'))

WebUI.click(findTestObject('Register Page/Rhithmic_professional_trader_radiobutton'))
